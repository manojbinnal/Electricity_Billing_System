...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        //x: The x-coordinate of the component's top-left corner relative to its container.
        //y: The y-coordinate of the component's top-left corner relative to its container.
        //width: The width of the component.
        //height: The height of the component.

         //JPanel:
        //
        //JPanel is a container class in Java Swing that is used to group and organize other GUI components. It acts as a lightweight container that can hold other components such as buttons, labels, text fields, etc.
        //JPanel provides a way to group components together, which makes it easier to manage and organize the GUI elements of an application.


        //JFrame is a top-level container class in Java Swing that represents the main window of a GUI application.
        //It provides the basic functionalities of a window, including title bar, maximize, minimize, close buttons, and the ability to be moved and resized by the user.
        p1 = new JPanel();
