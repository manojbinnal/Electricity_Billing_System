...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        super("Electricity Billing System"); // namming title throught JFram
        this.meter = meter;
        ...
        JLabel l1 = new JLabel(icc3);  //adding the image to the label
        add(l1);


        //THIS IS FOR ADMINS LOGIN!!!!!!!!
        /* First Column */
        ...
        m1.setMnemonic('D');
        m1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.CTRL_MASK));//which is used whenever we press the menu item and handling the key events
        m1.setBackground(Color.WHITE);

        //m4.setMnemonic('B');
        //setMnemonic() method sets the mnemonic for the menu item. A mnemonic is a keyboard shortcut that allows users to activate the menu item without using the mouse. In this case, pressing the 'B' key while the menu is open (typically with the Alt key) will activate the menu item associated with the mnemonic.

        //m4.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.CTRL_MASK));
        //setAccelerator() method sets an accelerator for the menu item. An accelerator is a keyboard shortcut that triggers the menu item directly, regardless of whether the menu is open or not. The user can use the accelerator without having to navigate through the menu hierarchy.
        ...
        //-----------------------------
        //THIS IS FOR THE CUSTOMER LOGIN!!!!!!!!!!!!
        /* Second Column */
        ...
        // NOW SETTING UP THE MENU BAR FOR THE "ADMIN" OR "CUSTOMER"
